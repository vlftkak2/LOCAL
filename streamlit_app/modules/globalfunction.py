...
conn = pymssql.connect(host='192.168.104.182:1432', user='APR_ROOT', password='Aa1234!!', database='APR', charset="utf8", autocommit=True)
# conn_str= (
...
# 재고부족 확인
def TEST():
    fu_query = "SELECT TOP 10 CONVERT(NVARCHAR(50),Country) COUNTRY,CONVERT(NVARCHAR(50),Brand) BRAND,ORDERNUMBER FROM SHOPI01T"
